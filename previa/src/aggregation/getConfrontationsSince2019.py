...
confrontations2018 = pd.DataFrame(data2018[['Location','Date','Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2017 = pd.read_csv("../../data/external/mencsv/2017.csv")
confrontations2017 = pd.DataFrame(data2017[['Location','Date','Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2016 = pd.read_csv("../../data/external/mencsv/2016.csv")
confrontations2016 = pd.DataFrame(data2016[['Location','Date','Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2015 = pd.read_csv("../../data/external/mencsv/2015.csv")
confrontations2015 = pd.DataFrame(data2015[['Location','Date','Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2014 = pd.read_csv("../../data/external/mencsv/2014.csv")
confrontations2014 = pd.DataFrame(data2014[['Location','Date','Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2013 = pd.read_csv("../../data/external/mencsv/2013.csv")
confrontations2013 = pd.DataFrame(data2013[['Location','Date','Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2012 = pd.read_csv("../../data/external/mencsv/2012.csv")
confrontations2012 = pd.DataFrame(data2012[['Location','Date','Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2011 = pd.read_csv("../../data/external/mencsv/2011.csv")
confrontations2011 = pd.DataFrame(data2011[['Location','Date','Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2010 = pd.read_csv("../../data/external/mencsv/2010.csv")
confrontations2010 = pd.DataFrame(data2010[['Location','Date','Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
