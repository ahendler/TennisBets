...
confrontations2019 = pd.DataFrame(data2019[['Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2020 = pd.read_csv("../../data/external/mencsv/2020.csv")
confrontations2020 = pd.DataFrame(data2020[['Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
data2021 = pd.read_csv("../../data/external/mencsv/2021.csv")
confrontations2021 = pd.DataFrame(data2021[['Winner','Loser','AvgW','AvgL','Round','Wsets','Lsets']])
